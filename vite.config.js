    ...
    build: {
        rollupOptions: {
            input: {
                ...
                flowlms: resolve(__dirname, 'products/flowlms/index.html'),
                ...
                flowstatement: resolve(__dirname, 'products/flowstatement/index.html'),
                ...
                flowapp: resolve(__dirname, 'products/flowapp/index.html'),
                dashboardFlowapp: resolve(__dirname, 'dashboard/flowapp/index.html'),
                editorFlowapp: resolve(__dirname, 'dashboard/flowapp/editor.html'),
